...
public class StudentService implements IStudentService {
    ...
    public void save(StudentDTO studentDto) {
        Student student = new Student(studentDto.getId(), studentDto.getName(), studentDto.getDateOfBirth(), studentDto.getGender(), studentDto.getGrade(), studentDto.getClassRoom());
